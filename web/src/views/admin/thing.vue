      ...
      >
        <div>
          <a-form ref="myform" :label-col="{ style: { width: '80px' } }" :model="modal.form" :rules="modal.rules">
            <a-row :gutter="24">
              <a-col span="24">
                <a-form-item label="蛋糕名称" name="title">
              ...
              <a-col span="12">
                <a-form-item label="尺寸">
                  <a-input placeholder="请输入" v-model:value="modal.form.chicun" style="width: 100%" />
                </a-form-item>
              </a-col>
              <a-col span="12">
                <a-form-item label="规格" name="guige">
                  <a-select placeholder="请选择" allowClear v-model:value="modal.form.guige">
                    <a-select-option value="2-4人食">2-4人食</a-select-option>
                    <a-select-option value="5-9人食">5-9人食</a-select-option>
                    <a-select-option value="10-16人食">10-16人食</a-select-option>
                  </a-select>
                </a-form-item>
              </a-col>
              <a-col span="12">
                <a-form-item label="重量">
                  <a-input placeholder="请输入" v-model:value="modal.form.zhongliang" style="width: 100%" />
                </a-form-item>
              </a-col>
              <a-col span="12">
...
<script setup>
  ...
  const modal = reactive({
    ...
    rules: {
      ...
      guige: [{ required: true, message: '请选择', trigger: 'change' }],
  ...
  const handleOk = () => {
    myform.value
      ...
      .then(() => {
        ...
        formData.append('chicun', modal.form.chicun || '');
        formData.append('guige', modal.form.guige || '');
        formData.append('zhongliang', modal.form.zhongliang || '');
